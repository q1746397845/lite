...
public class HTTPStatus {
    ...
    public static final int VALID_CODE_ERROR = 5003;//验证码校验失败

    public static final int VALID_USER_PASSWORD_ERROR = 5004;//验证码校验失败

    public static final int VERIFY_ERROR = 403;
