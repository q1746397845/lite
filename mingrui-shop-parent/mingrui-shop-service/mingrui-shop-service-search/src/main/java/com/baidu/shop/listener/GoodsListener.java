...
public class GoodsListener {
    ...
    public void save(Message message, Channel channel) throws IOException {
        ...
        //新增数据到es
        shopElasticsearchService.saveEsData(Integer.valueOf(new String(message.getBody())));
    ...
    public void delete(Message message, Channel channel) throws IOException {
        ...
        //新增数据到es
        shopElasticsearchService.deleteEsData(Integer.valueOf(new String(message.getBody())));
        channel.basicAck(message.getMessageProperties().getDeliveryTag(), true);
    }
}
